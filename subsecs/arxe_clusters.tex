...
%ionization energies.
Since ionized atoms in clusters are stabilized by the cluster environment,
the atomic
...
Analyzing the absolute decay width values for the icosahedral and dodecahedral
