...
In relativistic treatment including the $jj$-coupling scheme
...
on properties of the atom $B$ explicetly.
...
\begin{table}[h]
 ...
 \begin{tabular}{c|cccc}
  ...
  \bottomrule
 \end{tabular}
 \caption{Evaluation of Wigner $3j$-symbols for $J=\frac 32$ in the argon-xenon
...
final state subspace can also be compared. It has to be kept in mind, that
...
widths of two different initial states with the same final states are compared.
