...
spectra by comparison of experimental spectra to theoretical calculations.
...
decay width data from the literature is used
for the neon dimer \cite{Averbukh06_1}, which was
obtained with the same method and a comparable basis set as for the NeAr
calculation.
...
to more decay partners. Hence, the decay width increases
...
which is chosen as an example.
The results for clusters of the class of an
...
to the left refers then to one more covered triangular surface with
either caps or layers.\\
...
An analysis of the peaks creating the shoulders reveals them to originate
from ICD processes involving next-nearest neighbours as decay partners.
...
five different cluster ensembles. I am able to explain the five experimental
spectra by different underlying mean structures. Furthermore, the peak structure
was shown to originate from ICD processes involving next-nearest
neighbours. From the results I conclude, that
