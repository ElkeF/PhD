...
One of the approaches to address the treatment of multi-state syytems is the
...
states is always chosen, which means equation (\ref{equation:Gamma_HQP}) applies.
