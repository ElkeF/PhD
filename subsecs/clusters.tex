...
As shown in figure \ref{figure:}, the clusters are created using a supersonic jet
...
measured in a specific time range after one synchrotron pulse. For the
electron electron coincidence, this time range is \unit[xyz]{fs}.
Two electrons measured in coincidence can stem from several physical
processes illustrated in figure \ref{figure:}
