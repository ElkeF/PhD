...
defining a cluster to consist of 2--50000 constituents.
\cite{Bjorneholm09}
...
comparateively large number of constituents are not completely surrounded
...
size, their relative number decreases and consequently those constituents
completely surrounded by other constituents, i.e. bulk atoms and molecules,
...
they are spherical symmetric and hence different orientations of the substituents
in the cluster are impossible and hence do not to be investigated.
...
Therefore the atomic solutions are reasonably well starting points for the
...
need not to be evaporated since they already are gaseous. Furthermore they are
thermically stable, easy to introduce into an apparatus
and the cleaning of the
apparatus after the experiment is fast and easily done, while cleaning
...
inhibit an attractive $R^{-6}$ behaviour.
...
Its repulsiv part takes care of the description of the
...
From the distance, homonuclear noble gas clusters look like a sphere
...
primary nucleation is supported. On the other hand the apparatus
...
Heteronuclear noble gas clusters can be created in two different ways:
the \emph{pick-up} method or co-expansion of two different gases.
...
of the parent cluster. Depending on the species types
and the experimental conditions different arrangements can be observed.
Either, few atoms
...
and lead through the expansion chamber. Here, perpendicular to the expansion
direction
...
For the
electron-electron coincidence, the coincidence time range is \unit[800]{fs}.
