...
small clusters of at least three constituents, even though one would in this
...
are reasonably good starting points for the
...
Experimentally, noble gas clusters can be prepared by expanding gas
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.85]{pics/exp_clusters1.pdf}
  \includegraphics[scale=0.85]{pics/exp_clusters2.pdf}
...
\ac{XAS}, also known as \ac{NEXAFS} probes the absorption of light
...
One pulse has of course many photons. However, only 1 in about 10000
...
\begin{figure}[h]
  ...
  \caption{Schematic illustration of electron-electron
           ...
           Printed with permission from \cite{PhDFoerstel}.
...
An example  of a coinicident electron spectrum is shown in
...
discussed in detail in chapter \ref{section:NeArclusters}.
