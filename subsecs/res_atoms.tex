...
%   \toprule
%                      & 4d$_{5/2,\pm 5/2}$ & 4d$_{5/2,\pm 3/2}$ & 4d$_{3/2,\pm 3/2}$ & 4d$_{3/2,\pm 1/2}$& 4d$_{nrel}$ & exp. 4d$_{5/2}$ & exp. 4d$_{3/2}$\\
%   \midrule                                                                                     
%   energy [\unit{eV}] &   66.87            &     66.87          &   68.91        &    68.91   &&& \\
%   pole strength      &     0.879          &      0.879         &    0.879       &     0.879  &&& \\
%   \midrule                                                                                    
%   $5s^{-2}$          & 2.34$\cdot10^{-2}$ & 2.30$\cdot10^{-2}$ & 1.73$\cdot10^{-2}$ & 1.62$\cdot10^{-2}$ & 6.27$\cdot10^{-4}$ &&\\
%   $5s^{-1}5p^{-1}$   & 5.40$\cdot10^{-2}$ & 5.34$\cdot10^{-2}$ & 3.35$\cdot10^{-2}$ & 3.21$\cdot10^{-2}$ & 1.50$\cdot10^{-2}$ &&\\
%   $5p^{-1}5p^{-1}$   & 8.45$\cdot10^{-2}$ & 8.57$\cdot10^{-2}$ & 8.15$\cdot10^{-2}$ & 8.21$\cdot10^{-2}$ & 3.21$\cdot10^{-2}$ &&\\
%   \midrule
%   total              & 0.1619$\pm$0.1     &   0.1621$\pm$0.1   &  0.1323$\pm$0.1    &   0.1304$\pm$0.1   &       & 0.105--0.116       & 0.110--0.130\\
%   \bottomrule                                                                                 
% \end{tabular}                                                                                 
