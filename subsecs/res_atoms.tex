...
effects. All calculations were performed with the FanoADC code implemented in
Dirac \cite{DIRAC13} with a dyall cv4z basis set with five s, p and d
and three additional diffuse basis functions
of the \ac{KBJ} type \cite{Kaufmann89}. All calculations were performed with
ADC(2x) accuracy.
...
the right panel of figure \ref{figure:Xe4p_SIPs_part}.
...
order between 5 and 37 shows a decay
