...
#   replacements = {'includegraphics[scale=0.5]':'input', '/compl':'/schale', '/incompl':'/in-shell', '_':'-core', '.ps':'', 'caps':'cap'}
   replacements = {'programme':'program', 'ill conditioned':'ill-conditioned', 'Lorentz-Transformation':'Lorentz transformation', 'Lorentz-transformation':'Lorentz transformation'}
