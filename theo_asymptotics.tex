\section{Decay Widths of ICD-like Processes in the Asymptotic Limit}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.7]{pics/taylor_pspic.eps}
%\input{taylor_pspic}
...
\subsection{Interatomic Coulombic Decay}
\label{subs_icd}

\begin{figure}[ht]
\centering
\includegraphics[scale=0.23]{pics/ICD_subsystems.eps}
...
\subsection{Electron Transfer Mediated Decay}
\label{subs_etmd}

\begin{figure}[ht]
\centering
\includegraphics[scale=0.18]{pics/ETMD_subsystems.eps}
...
\includegraphics[scale=0.77]{pics/coord_etmd_pspic.eps}
